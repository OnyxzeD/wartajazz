...
class Outlet extends Partner_Middleware
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model(array('Outlet_model', 'Partner_model'));
    }
    ...
    public function index()
    {
        ...
        $vars['View'] = 'Partner/Outlet/index';
        $vars['Data'] = $this->Outlet_model->listData();
    ...
    public function modalDetail($id)
    {
        ...
        $this->load->view('Partner/Outlet/modal-detail', $vars);
    }
