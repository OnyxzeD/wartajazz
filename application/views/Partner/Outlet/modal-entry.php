<form id="MyForm" method="post" role="form">
    ...
    <div class="row form-group">
        <div class="col-md-10">
            <label>Alamat</label>
            <input type="text" class="form-control" name="outlet-alamat"
    ...
    <div class="row form-group">
        <div class="col-md-10">
            ...
            <input type="text" class="form-control" name="outlet-kursi" onkeydown="validateNumber(event)"
                   value="<?= (isset($data['Jumlah_Kursi']) ? (int)$data['Jumlah_Kursi'] : "") ?>">
        </div>
    </div>
    <div class="row form-group">
        <div class="col-md-10">
