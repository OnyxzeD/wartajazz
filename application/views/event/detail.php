<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <h5 style="display: inline-block; margin: 5px;"><i
                    class="fa fa-info-circle"></i> Created by <?= $data['author'] ?> at <?= convertDate($data['date_create'], 'indo') ?></h5>
    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <img class="img-responsive" style="margin: 0 auto; height: 400px; width: auto" src="<?= $data['poster'] ?>" alt="User profile picture">
            </div>
            <div class="col-md-6">
                <div style="margin-left: 20px; margin-right: 20px">
                    ...
                    <p class="text-muted" style="font-size: 18px"><?= convertDate($data['date_start'], 'indo') .' s/d '.convertDate($data['date_end'], 'indo'); ?></p>
                    <hr>
                    <strong style="font-size: 18px"><i class="fa fa-usd margin-r-5"></i> Harga Tiket</strong>
                    <p class="text-muted" style="font-size: 18px">Rp <?= number_format($data['htm'], 0, ".", "."); ?></p>
                    <hr>
                ...
                <ul class="list-group list-group-unbordered" style="margin-left: 20px; margin-right: 20px">
                    ...
                    <li class="list-group-item">
                        <b><?= $d['artist_name']?></b> <a class="pull-right"><?= $d['country_of_origin']?></a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
